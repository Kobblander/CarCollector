...
public class GameAdapter {
    ...
    public long insertPlayer(Player p) {
        ...
        contentValues.put( playersCols[2], p.getLevelCur());
        contentValues.put( playersCols[3], p.getLevelOld());
        contentValues.put( playersCols[4], p.getXpForNextLevelCur());
        contentValues.put( playersCols[5], p.getXpForNextLevelOld());
        contentValues.put( playersCols[6], p.getLevelXpCur());
        contentValues.put( playersCols[7], p.getLevelXpOld());
        contentValues.put( playersCols[8], p.getTotalXpCur());
        contentValues.put( playersCols[9], p.getTotalXpOld());
        openToWrite();
    ...
    public long insertCarType(CarType ct) {
        ...
        contentValues.put( typesCols[3], ct.getLevelCur());
        contentValues.put( typesCols[4], ct.getLevelOld());
        contentValues.put( typesCols[5], ct.getXpForNextLevelCur());
        contentValues.put( typesCols[6], ct.getXpForNextLevelOld());
        contentValues.put( typesCols[7], ct.getLevelXpCur());
        contentValues.put( typesCols[8], ct.getLevelXpOld());
        contentValues.put( typesCols[9], ct.getTotalXpCur());
        contentValues.put( typesCols[10], ct.getTotalXpOld());
        openToWrite();
    ...
    public long insertCarSubType(CarSubType cst) {
        ...
        contentValues.put( subTypesCols[3], cst.getLevelCur());
        contentValues.put( subTypesCols[4], cst.getLevelOld());
        contentValues.put( subTypesCols[5], cst.getXpForNextLevelCur());
        contentValues.put( subTypesCols[6], cst.getXpForNextLevelOld());
        contentValues.put( subTypesCols[7], cst.getLevelXpCur());
        contentValues.put( subTypesCols[8], cst.getLevelXpOld());
        contentValues.put( subTypesCols[9], cst.getTotalXpCur());
        contentValues.put( subTypesCols[10], cst.getTotalXpOld());
        contentValues.put( subTypesCols[11], cst.getTotalCarsCur());
        contentValues.put( subTypesCols[12], cst.getTotalCarsOld());
        openToWrite();
